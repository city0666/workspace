...
public class Pinyin {//常见汉字的拼音
	...
	private static int[] code = { -10254, -10256, -10260, -10262, -10270,//常用字的编码
	...
	public static String getPinyin(String gb2312) {
		...
		for (int i = 0, Len = chars.length; i < Len; i++) {
			retuBuf.append(getPinyinchar(chars[i]));

		}
		return retuBuf.toString();
	}

	public static String getPinyinchar(char gb2312) {
